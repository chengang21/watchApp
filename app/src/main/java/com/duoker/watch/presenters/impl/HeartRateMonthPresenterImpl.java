...
public class HeartRateMonthPresenterImpl extends HeartRateMonthPresenter
{
    private float allRecord;
    private float averageRecord;
    private float highRecord;
    private float lowRecord;
    private final HeartRateMonthPresenter.View iView;
    ...
    private Comparator<HeartRateBean> mComparator = new Comparator<HeartRateBean>() {
        @Override
        public int compare(HeartRateBean o1, HeartRateBean o2)
        {
            long l1 = o1.getCalcTime();
            long l2 = o2.getCalcTime();
            if (l1 > l2)
                return 1;
            if (l1 == l2)
                return 0;
    ...
    public HeartRateMonthPresenterImpl(HeartRateMonthPresenter.View paramView, Context paramContext, HeartRateRepository paramHeartRateRepository)
    {
    ...
    {
        DateHelper.BeginNEndItem localBeginNEndItem = DateHelper.getMonthBeginNEnd(this.mNowDate);
        long l1 = localBeginNEndItem.getBeginTime().getTime() / 1000L;
        long l2 = localBeginNEndItem.getEndTime().getTime() / 1000L;
        ...
        new GetHeartRateInteractorImpl(str1, str2, l1, l2, this.mHeartRateRepository).execute(new SimpleCallback<List<HeartRateBean>>()
        {
