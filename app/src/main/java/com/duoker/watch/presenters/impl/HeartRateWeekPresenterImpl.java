...
public class HeartRateWeekPresenterImpl extends HeartRateWeekPresenter {
    private float allRecord;
    private float averageRecord;
    private float highRecord;
    private float lowRecord;
    private final HeartRateWeekPresenter.View iView;
    ...
    public HeartRateWeekPresenterImpl(HeartRateWeekPresenter.View view, Context context, HeartRateRepository heartRateRepository) {
        this.iView = view;
    ...
    public void getHeartRate() {
        DateHelper.BeginNEndItem localBeginNEndItem = DateHelper.getWeekBeginNEnd(this.mNowDate);
